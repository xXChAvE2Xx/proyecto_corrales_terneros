...
Route::get('/edit/{id}', [App\Http\Controllers\BreedingController::class, 'edit'])->name('breeding.edit');
Route::patch('/edit/{id}', [App\Http\Controllers\BreedingController::class, 'update'])->name('breeding.update');

Route::get('/show/{id}', [App\Http\Controllers\BreedingController::class, 'show'])->name('breeding.show');
